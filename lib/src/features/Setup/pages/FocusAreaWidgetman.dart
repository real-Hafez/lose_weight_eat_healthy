...
class FocusAreaWidget_man extends StatefulWidget {
  const FocusAreaWidget_man({
    super.key,
  ...
  @override
  State<FocusAreaWidget_man> createState() => _FocusAreaWidget_manState();
}

class _FocusAreaWidget_manState extends State<FocusAreaWidget_man> {
