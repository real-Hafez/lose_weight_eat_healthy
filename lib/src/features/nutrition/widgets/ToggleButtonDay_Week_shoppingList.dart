...
// import 'package:lose_weight_eat_healthy/src/features/nutrition/features/Day_page/Pages/Dayview.dart';
...
//   bool isFirstBuild = true; // Track if it's the first time the widget is built
...
//     // Open the DayPage only on the first build
//     if (isFirstBuild) {
//       isFirstBuild = false; // Set to false after the first navigation

//       // Use addPostFrameCallback to avoid setState issues during build
...
//           Navigator.push(
//             context,
//             MaterialPageRoute(builder: (context) => const WeekView()),
//           );
